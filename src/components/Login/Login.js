                        ...
                        <div className="col-md-12">
                            <div className="card m-auto" style={{maxWidth: '25rem',boxShadow:'0 0 8px 5px #6e596e42'}}>
                                ...
                                <span style={{display:'block',textAlign:'center',margin: '15px 0',color:'red',fontSize:'20px',textDecoration:'none',fontWeight:'700'}}>Log In Here</span>
                                    <form>
                                        <input name="email"  onChange={InputEvent} className='form-control my-3' placeholder="Enter Email" required />

                                        <input name="password"  onChange={InputEvent} className='form-control my-3' type="password" placeholder="Enter Password" required />
